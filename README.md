# Go Soap [![Build Status](https://travis-ci.org/Orisun/gosoap.svg?branch=master)](https://travis-ci.org/Orisun/gosoap) [![GoDoc](https://godoc.org/github.com/Orisun/gosoap?status.png)](https://godoc.org/github.com/Orisun/gosoap) [![Go Report Card](https://goreportcard.com/badge/github.com/Orisun/gosoap)](https://goreportcard.com/report/github.com/Orisun/gosoap) [![Coverage Status](https://coveralls.io/repos/github/Orisun/gosoap/badge.svg?branch=master)](https://coveralls.io/github/Orisun/gosoap?branch=master) [![patreon](https://img.shields.io/badge/patreon-donate-yellow.svg)](https://www.patreon.com/temporin) [![Known Vulnerabilities](https://snyk.io/test/github/Orisun/gosoap/badge.svg)](https://snyk.io/test/github/Orisun/gosoap)
package to help with SOAP integrations (client)

### Install

```bash
go get github.com/Orisun/gosoap
```
